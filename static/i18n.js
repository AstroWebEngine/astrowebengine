...
en: {
  ...
  'fleet.size': 'Size',
  'fleet.ships': 'Ships',
  'fleet.noFleets': 'No fleets yet — build ships in a base\'s Production tab to form your first fleet.',
  'fleet.speed': 'Speed',
  'fleet.hangar': 'Hangar',
...
es: {
  ...
  'fleet.size': 'Tamano',
  'fleet.ships': 'Naves',
  'fleet.noFleets': 'Sin flotas aun — construye naves en la pestana Produccion de una base para formar tu primera flota.',
...
fr: {
  ...
  'fleet.noFleets': 'Pas encore de flottes — construisez des vaisseaux dans l\'onglet Production d\'une base pour former votre premiere flotte.',
  'fleet.speed': 'Vitesse',
  'fleet.hangar': 'Hangar',
...
de: {
  ...
  'fleet.size': 'Grosse',
  'fleet.ships': 'Schiffe',
  'fleet.noFleets': 'Noch keine Flotten — baue Schiffe im Produktions-Tab einer Basis, um deine erste Flotte aufzustellen.',
...
pt: {
  ...
  'fleet.size': 'Tamanho',
  'fleet.ships': 'Naves',
  'fleet.noFleets': 'Sem frotas ainda — construa naves na aba Producao de uma base para formar sua primeira frota.',
